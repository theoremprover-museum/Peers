...
FILE *fp;
{
    ...
    fprintf(fp, "Demod rewrite attmepts   %7ld\n", Stats[REWRITE_ATTEMPTS]);
    ...
    fprintf(fp, "\n");
    fprintf(fp, "Clauses deleted by update%7ld\n", Stats[CLAUSES_UDB_DELETED]);
    fprintf(fp, "Residents                %7ld\n", Stats[RESIDENTS]);
    fprintf(fp, "Generated by expansion   %7ld\n", Stats[EXP_GENERATED]);
    fprintf(fp, "Kept in process_new_cl   %7ld\n", Stats[NEW_CLAUSE_KEPT]);
    fprintf(fp, "Inferences msgs broadcast%7ld\n", Stats[IM_BROADCAST]);
    fprintf(fp, "Inference msgs received  %7ld\n", Stats[IM_RECEIVED]);
    fprintf(fp, "Inference msgs kept      %7ld\n", Stats[IM_KEPT]);
    fprintf(fp, "New settlers sent        %7ld\n", Stats[NS_SENT]);
    fprintf(fp, "New settlers received    %7ld\n", Stats[NS_RECEIVED]);
    fprintf(fp, "New settlers kept        %7ld\n", Stats[NS_KEPT]);
    fprintf(fp, "Residents back demod     %7ld\n", Stats[BD_RESIDENTS]);
    fprintf(fp, "Inference msgs back demod%7ld\n", Stats[BD_INF_MSGS]);
    fprintf(fp, "Back demod res kept (name)%6ld\n", Stats[BD_KEPT_NAME_RES]);
    fprintf(fp, "Back demod im kept (name)%7ld\n", Stats[BD_KEPT_NAME_IM]);
...
FILE *fp;
{
    ...
    fprintf(fp, "new settler time    %10.2f\n", clock_val(NEW_SETTLER_TIME) / 1000.);
    fprintf(fp, "expansion work time %10.2f\n", clock_val(EXPANSION_TIME) / 1000.);
